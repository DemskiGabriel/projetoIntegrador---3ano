...
import { IonCard, IonIcon, IonItem, IonImg, IonLabel, IonContent, IonFab, IonFabButton, IonCardContent, IonCardHeader } from '@ionic/angular/standalone';
...
@Component({
  ...
  standalone: true,
  imports: [IonCardContent, IonFabButton, IonFab, IonIcon, IonCard, IonItem, IonLabel, IonImg, CommonModule, FormsModule, IonContent, RouterLink, IonCardHeader]
})
